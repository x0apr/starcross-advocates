...
<?php else: ?>
	<h1><?php esc_html_e( 'Welcome to' ); echo ' '. apply_filters('betheme_label', 'Betheme'); ?></h1>
<?php endif; ?>
...
<h2 class="nav-tab-wrapper wp-clearfix">
	...
	<?php if( ! $is_support_disabled && ! WHITE_LABEL ): ?>
	...
	<?php if( ! $is_changelog_disabled && ! WHITE_LABEL ): ?>
	...
	<a href="admin.php?page=<?php echo apply_filters('betheme_slug', 'be'); ?>-tools" class="nav-tab<?php if( $current_screen == 'betheme_page_be-tools' ) echo ' nav-tab-active'; ?>"><?php esc_html_e( 'Tools', 'mfn-opts' ); ?></a>
