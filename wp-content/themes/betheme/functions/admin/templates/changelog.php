...
<div id="mfn-dashboard" class="wrap about-wrap">
	...
	<div class="dashboard-tab changes">
		...
		<div class="col col-fw">
			...
			<h3 class="primary"><?php esc_html_e( 'Changelog', 'mfn-opts' ); ?> <a target="_blank" class="external" href="https://support.muffingroup.com/changelog/"><?php esc_html_e( 'see what is new', 'mfn-opts' ); ?></a></h3>
