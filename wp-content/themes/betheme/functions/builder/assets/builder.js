  ...
  var MfnBuilder = (function($) {
    ...
    var templatesPostType = {
      ...
      set: function() {
        ...
        var val = $('.mfn_template_type .mfn-field-value').val();
        ...
        if( val == 'single-product' || val == 'shop-archive' ){
      ...
      beforeUpdate: function() {
        $('.showmodalonsave').on('click', function(e) {
          if( $('.mfn_template_type .mfn-field-value').val() == 'single-product' || $('.mfn_template_type .mfn-field-value').val() == 'shop-archive' ){
            e.preventDefault();
            $('.modal-display-conditions').addClass('show');
          }

          $('.mfn_template_type .mfn-field-value').on('change', function() {
            $('.modal-display-conditions .mfn-df-row:not(.clone) .df-remove').trigger('click');
          });
