									...
									foreach( $wrap['items'] as $item_key => $item ){
										...
										if( isset( $item['fields'] ) && is_array( $item['fields'] ) ){
											foreach( $item['fields'] as $field_key => $field ) {
												...
												if( is_array( $field ) && is_iterable($field) ){
													...
													foreach( $field as $tab_key => $tab ){
														...
														if( is_array( $tab ) ){
															foreach( $tab as $tab_field_key => $tab_field ){
																...
																$meta_value[$sec_key]['wraps'][$wrap_key]['items'][$item_key]['fields'][$field_key][$tab_key][$tab_field_key] = $field;
					...
					<?php if( ! $this->error ): ?>
						...
						<div class="import-all-done item" data-id="<?php echo esc_attr( $this->demo ); ?>">
							...
							<div class="done-buttons">
								<?php
									echo '<a target="_blank" href="admin.php?page='. apply_filters('betheme_slug', 'be') .'-options" class="mfn-button mfn-button-secondary">Go to '. apply_filters('betheme_label', 'Be') .' Theme Options</a>';
													...
													if( $builder_selector ){
														...
														echo '<ul class="select-builder clearfix">';
															...
															echo '<li class="muffin active" data-builder="">';
																echo '<span class="builder-title">BeBuilder</span>';
