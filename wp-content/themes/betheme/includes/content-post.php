										...
										$output .= '<div class="author-date">';
											...
											if( isset( $list_meta['author'] ) ){
												$output .= '<span class="vcard author post-author">';
													...
													$output .= '<i class="icon-user" aria-label="author"></i> ';
											...
											if( isset( $list_meta['date'] ) ){
												$output .= '<span class="date">';
													...
													$output .= '<i class="icon-clock" aria-label="published"></i> ';
											...
											if( 'masonry tiles' == $style && comments_open() && mfn_opts_get( 'blog-comments' ) ){
												$output .= '<div class="post-links">';
													$output .= '<i class="icon-comment-empty-fa" aria-label="number of comments"></i> <a href="'. esc_url(get_comments_link()) .'" class="post-comments">'. esc_html(get_comments_number()) .'</a>';
												$output .= '</div>';
											}
