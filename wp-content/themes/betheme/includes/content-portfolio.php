								...
								if( $external != 'disable' ){
									$output .= '<div class="links-wrapper clearfix">';
										...
										if( ! in_array( $external, array('_self','_blank') ) ){
											if( ! empty($large_image_url[0]) ){
												$output .= '<a class="zoom" href="'. esc_url($large_image_url[0]) .'" rel="prettyphoto"><i class="icon-search" aria-label="zoom image"></i></a>';
											}
										}
										if( $ext_link ){
											$output .= '<a class="external" target="_blank" href="'. esc_url($ext_link) .'" ><i class="icon-forward" aria-label="go to external link"></i></a>';
										}
										if( ! $external ){
											$output .= $link_before_escaped. '<i class="icon-link" aria-label="go to link"></i></a>';
										}
							...
							if( $style == 'list' ){
								...
								$output .= '<div class="list_style_header">';
									...
									$output .= '<div class="links_wrapper">';
										$output .= '<a href="#" class="button the-icon portfolio_prev_js"><span class="button_icon"><i class="icon-up-open" aria-label="previous project"></i></span></a>';
										$output .= '<a href="#" class="button the-icon portfolio_next_js"><span class="button_icon"><i class="icon-down-open" aria-label="next project"></i></span></a>';
										$output .= '<a href="'. esc_url(get_permalink()) .'" class="button button_theme has-icon"><span class="button_icon"><i class="icon-link" aria-label="all projects"></i></span><span class="button_label">'. $button_text .'</span></a>';
									$output .= '</div>';
								$output .= '</div>';
